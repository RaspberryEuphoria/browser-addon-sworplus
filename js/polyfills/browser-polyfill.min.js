    ...
    if ('undefined' == typeof browser || Object.getPrototypeOf(browser) !== Object.prototype) {
      ...
      a.exports = (a => {
        ...
        const d = a => a && 'object' == typeof a && 'function' == typeof a.then,
          e = (b, c) => (...d) => {
            a.runtime.lastError
              ? b.reject(a.runtime.lastError)
              : c.singleCallbackArg || (1 >= d.length && !1 !== c.singleCallbackArg)
              ? b.resolve(d[0])
              : b.resolve(d);
          },
          ...
          g = (a, b) =>
            function(c, ...d) {
              ...
              return new Promise((f, g) => {
                ...
                else b.noCallback ? (c[a](...d), f()) : c[a](...d, e({ resolve: f, reject: g }, b));
              });
            },
          h = (a, b, c) =>
            new Proxy(b, {
              ...
              e = {
                ...
                get(e, f, k) {
                  ...
                  if ('function' == typeof l) {
                    if ('function' == typeof b[f]) l = h(a, a[f], b[f]);
                    else if (i(c, f)) {
                      let b = g(f, c[f]);
                      l = h(a, a[f], b);
                    } else l = l.bind(a);
                  ...
                  const k = a => {
                    a.then(
                      ...
                      a => {
                        let b;
                        (b =
                          a && (a instanceof Error || 'string' == typeof a.message)
                            ? a.message
                            : 'An unexpected error occurred'),
                          e({ __mozWebExtensionPolyfillReject__: !0, message: b });
                      },
                    ).catch(a => {
        ...
        return (
          (b.privacy = { network: { '*': q }, services: { '*': q }, websites: { '*': q } }),
          j(a, p, b)
        );
      })(chrome);
